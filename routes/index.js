...
router.post('/escapeRooms',                   upload.single('image'), escapeRoomController.create);
router.get('/escapeRooms/:escapeRoomId(\\d+)/edit',  escapeRoomController.edit);
router.put('/escapeRooms/:escapeRoomId(\\d+)',       upload.single('image'),escapeRoomController.update);
